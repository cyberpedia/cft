...
import os # Import os for base directory join
...
INSTALLED_APPS = [
    'channels',        # Added for Django Channels, should be at the top
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Added for CORS, should be very high
...
ASGI_APPLICATION = 'ctf_platform.asgi.application' # Channels ASGI application
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny', # Default permission for now, will be refined per view
    ),
